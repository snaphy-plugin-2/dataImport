...
module.exports = function( server, databaseObj, helper, packageObj) {
	 ...
	 * It is a constructor and is populated 'use strict';
module.exports = function( server, databaseObj, helper, packageObj) {
	/**
	 * Here server is the main app object
	 * databaseObj is the mapped database from the package.json file
	...
	let {beforeSave} = require("./beforeSave")(server, databaseObj, helper, packageObj);
	let {afterSave} = require("./afterSave")(server, databaseObj, helper, packageObj);
	const uploadFile = require("./uploadFile")(server, databaseObj, helper, packageObj);
	const filePath = packageObj.filePath;
	///Modify before save..
	beforeSave = filePath.beforeSave? require(filePath.beforeSave)(server, databaseObj, helper, packageObj).beforeSave: beforeSave;
	afterSave = filePath.afterSave? require(filePath.afterSave)(server, databaseObj, helper, packageObj).afterSave: afterSave;
